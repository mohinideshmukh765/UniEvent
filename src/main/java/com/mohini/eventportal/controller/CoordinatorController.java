...
public class CoordinatorController {
    ...
    public ResponseEntity<?> createEvent(@RequestBody Event eventData) {
        ...
        Event event = Event.builder()
                ...
                .requiresName(eventData.getRequiresName())
                .requiresEmail(eventData.getRequiresEmail())
                .requiresCollege(eventData.getRequiresCollege())
                .requiresPayment(eventData.getRequiresPayment())
                .college(college)
